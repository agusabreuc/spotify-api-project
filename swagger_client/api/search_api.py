...
class SearchApi(object):
    ...
    def search(self, q, type, **kwargs):  # noqa: E501
        ...
        >>> thread = api.search(q, type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str q: (required)
        :param list[str] type: (required)
        :param str market:
        :param int limit:
        :param int offset:
        :param str include_external:
        ...
        if kwargs.get('async_req'):
            return self.search_with_http_info(q, type, **kwargs)  # noqa: E501
        else:
            (data) = self.search_with_http_info(q, type, **kwargs)  # noqa: E501
            return data

    def search_with_http_info(self, q, type, **kwargs):  # noqa: E501
        """Search for Item   # noqa: E501

        Get Spotify catalog information about albums, artists, playlists, tracks, shows, episodes or audiobooks that match a keyword string.<br /> **Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.**   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_with_http_info(q, type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['q', 'type', 'market', 'limit', 'offset', 'include_external']  # noqa: E501
        ...
        if 'include_external' in params:
            query_params.append(('include_external', params['include_external']))  # noqa: E501
