...
class ChaptersApi(object):
    ...
    def get_a_chapter(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_a_chapter(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_a_chapter_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_a_chapter_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_a_chapter_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a Chapter   # noqa: E501

        Get Spotify catalog information for a single chapter.<br /> **Note: Chapters are only available for the US, UK, Ireland, New Zealand and Australia markets.**   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_a_chapter_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_a_chapter`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ChapterObject',  # noqa: E501
    ...
    def get_several_chapters(self, ids, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_several_chapters(ids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_several_chapters_with_http_info(ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_several_chapters_with_http_info(ids, **kwargs)  # noqa: E501
            return data

    def get_several_chapters_with_http_info(self, ids, **kwargs):  # noqa: E501
        """Get Several Chapters   # noqa: E501

        Get Spotify catalog information for several chapters identified by their Spotify IDs.<br /> **Note: Chapters are only available for the US, UK, Ireland, New Zealand and Australia markets.**   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_several_chapters_with_http_info(ids, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_several_chapters" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('ids' not in params or
                params['ids'] is None):
            raise ValueError("Missing the required parameter `ids` when calling `get_several_chapters`")  # noqa: E501
